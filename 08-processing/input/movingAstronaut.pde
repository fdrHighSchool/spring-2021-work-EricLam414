...
void draw(){
  ...
  if(mouseY < 345){
    ...
    fillRed();
    triangle(229, 225, 140, 345, 140, 225);
    triangle(369, 225, 456, 225, 456, 126);
    fillWhite();
    triangle(140, 345, 140, 395, 450, 395);
    triangle(190, 76, 456, 126, 456, 76);
    fillCyan();
    arc(140, 370, 50, 50, radians(90), radians(270));
    triangle(369, 225, 456, 225, 369, 345);
    arc(456, 100, 50, 50, radians(270), radians(450));
    fills(184,216,211,255);
    arc(140, 370, 50, 50, radians(270), radians(450));
    arc(456, 100, 50, 50, radians(90), radians(270));
    fillBrown();
    triangle(190, 76, 190, 126, 140, 76);
    triangle(450, 395, 450, 345, 500, 395);
    fills(233,241,236,255);
    triangle(140, 126, 190, 126, 140, 76);
    triangle(500, 345, 450, 345, 500, 395);
  }
